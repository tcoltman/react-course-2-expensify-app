...
const expenseOne = store.dispatch(addExpense({description:'Rent',amount:12000,createdAt:11}));
const expenseTwo = store.dispatch(addExpense({description:'Coffee',amount:22000,createdAt:21}));
...
// store.dispatch(sortByDate());
 ...
 //store.dispatch(setStartDate(21));
// store.dispatch(setStartDate());
 //store.dispatch(setEndDate(22));
